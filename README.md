 ...
 *IMPORTANT NOTE!!*
 with the API we were given for this projects there is a bug that only the admin user can change the role of the other users or else the user's role is guest no matter what.
